...
var _Zimmi48$ttt2017$Main$myStyle = {
	ctor: '::',
	_0: _rtfeldman$elm_css$Css_Elements$body(
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							_rtfeldman$elm_css$Css$hex('effafa')),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$color(
								A3(_rtfeldman$elm_css$Css$rgb, 0, 0, 0)),
							_1: {
								...
								_0: _rtfeldman$elm_css$Css$fontFamilies(
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$qt('Open Sans'),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$sansSerif.value,
											_1: {ctor: '[]'}
										}
									}),
								_1: {
										...
										_1: {
											...
											_1: {
												...
												_0: _rtfeldman$elm_css$Css$lineHeight(
													_rtfeldman$elm_css$Css$pct(150)),
												_1: {ctor: '[]'}
											}
										}
									}
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$alignItems(_rtfeldman$elm_css$Css$left),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						_0: _rtfeldman$elm_css$Css_Elements$footer(
							{
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$lineHeight(
										_rtfeldman$elm_css$Css$pct(130)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
										...
										_0: _rtfeldman$elm_css$Css_Elements$code(
											{
												...
												_1: {
													...
													_0: _rtfeldman$elm_css$Css$fontFamilies(
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$qt('Nova Mono'),
															_1: {
																ctor: '::',
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Css$color(
																A3(_rtfeldman$elm_css$Css$rgb, 0, 100, 255)),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _Zimmi48$ttt2017$Main$md = A2(
	_evancz$elm_markdown$Markdown$toHtmlWith,
	{
		githubFlavored: _elm_lang$core$Maybe$Just(
...
var _Zimmi48$ttt2017$Main$applyComparison = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$reflect = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$applyExamples = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$applyTechnical = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$apply = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$comparison = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$transfer = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$rewriteExample = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$rewriteTechnical = {
	ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _Zimmi48$ttt2017$Main$md('**Cf.** Sozeau, M. (2010). [A new look at generalized rewriting in type theory.](https://jfr.unibo.it/article/view/1574) *J. Form. Reason.* 2(1), 41-62.'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _Zimmi48$ttt2017$Main$rewrite = {
	ctor: '::',
...
var _Zimmi48$ttt2017$Main$tactics = {
	ctor: '::',
	_0: _Zimmi48$ttt2017$Main$md('\n\n## Tactics\n\nBuilding blocks for proofs.\n\nFrom **primitive** (exact)...\nto **semi-automatic** (rewrite)...\nto **automatic** (tauto).\n\n'),
	_1: {ctor: '[]'}
};
var _Zimmi48$ttt2017$Main$introduction = function (x) {
	return {
		ctor: '::',
		_0: x,
		_1: {ctor: '[]'}
...
var _Zimmi48$ttt2017$Main$title = {
	ctor: '::',
	_0: _Zimmi48$ttt2017$Main$md('\n\nCoq\'s Prolog and applications to defining semi-automatic tactics\n================================================================\n\nThéo Zimmermann and Hugo Herbelin\n\nTTT 2017\n\n'),
	_1: {ctor: '[]'}
};
var _Zimmi48$ttt2017$Main$main = A2(
	_xarvh$elm_slides$Slides$app,
	_elm_lang$core$Native_Utils.update(
		_xarvh$elm_slides$Slides$slidesDefaultOptions,
		{style: _Zimmi48$ttt2017$Main$myStyle}),
	A2(
		_elm_lang$core$List$map,
		_xarvh$elm_slides$Slides$htmlFragments,
		{
			ctor: '::',
			_0: _Zimmi48$ttt2017$Main$title,
			_1: {
				ctor: '::',
				_0: _Zimmi48$ttt2017$Main$introduction,
				_1: {
					ctor: '::',
					_0: _Zimmi48$ttt2017$Main$tactics,
					_1: {
						ctor: '::',
						_0: _Zimmi48$ttt2017$Main$rewrite,
						_1: {
							ctor: '::',
							_0: _Zimmi48$ttt2017$Main$rewriteTechnical,
							_1: {
								ctor: '::',
								_0: _Zimmi48$ttt2017$Main$rewriteExample,
								_1: {
									ctor: '::',
									_0: _Zimmi48$ttt2017$Main$transfer,
									_1: {
										ctor: '::',
										_0: _Zimmi48$ttt2017$Main$comparison,
										_1: {
											ctor: '::',
											_0: _Zimmi48$ttt2017$Main$apply,
											_1: {
												ctor: '::',
												_0: _Zimmi48$ttt2017$Main$applyTechnical,
												_1: {
													ctor: '::',
													_0: _Zimmi48$ttt2017$Main$applyExamples,
													_1: {
														ctor: '::',
														_0: _Zimmi48$ttt2017$Main$reflect,
														_1: {
															ctor: '::',
															_0: _Zimmi48$ttt2017$Main$applyComparison,
															_1: {
																ctor: '::',
																_0: _Zimmi48$ttt2017$Main$typeclasses,
																_1: {
																	ctor: '::',
																	_0: _Zimmi48$ttt2017$Main$conclusion,
																	_1: {ctor: '[]'}
																}
															}
														}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Zimmi48$ttt2017$Main$main !== 'undefined') {
    _Zimmi48$ttt2017$Main$main(Elm['Main'], 'Main', undefined);
}
